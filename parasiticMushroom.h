#ifndef _PARASITIC_MUSHROOM_H               // Prevent multiple definitions if this 
#define _PARASITIC_MUSHROOM_H               // file is included in more than one place
#define WIN32_LEAN_AND_MEAN

#include "mushroom.h"
#include "mushroomParasiteUnit.h"

class ParasiticMushroom : public Mushroom
{
public:
	// constructor
	ParasiticMushroom();
	...
	virtual int   getStartFrame()   {return PARASITIC_MUSHROOM_START_FRAME;}
	virtual int   getEndFrame()     {return PARASITIC_MUSHROOM_END_FRAME;}
