...
{ 
    ...
    hwnd = CreateWindow(
        ...
        FULL_GAME_WIDTH,             // width of window
        FULL_GAME_HEIGHT,            // height of the window
    ...
    if(!FULLSCREEN)             // if window
    {
        ...
        MoveWindow(hwnd,
                   0,                                           // Left
                   0,                                           // Top
                   FULL_GAME_WIDTH+(FULL_GAME_WIDTH-clientRect.right),    // Right
                   FULL_GAME_HEIGHT+(FULL_GAME_HEIGHT-clientRect.bottom), // Bottom
