#ifndef _NEMATODE_CLOSE_COMBAT_UNIT_H               // Prevent multiple definitions if this 
#define _NEMATODE_CLOSE_COMBAT_UNIT_H               // file is included in more than one place
...
class NematodeCloseCombatUnit : public NematodeUnit
{
protected:
public:
	// constructor
	NematodeCloseCombatUnit();
	NematodeCloseCombatUnit(float, float, int, int, int, float, float);
