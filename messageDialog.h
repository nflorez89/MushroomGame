...
namespace messageDialogNS
{
    ...
    static const char* BUTTON1_TEXT[MAX_TYPE] = {"CANCEL", "WAIT", "WAIT", "", "Cancel"};
    static const char* BUTTON2_TEXT[MAX_TYPE] = {"SPAWN", "", "ATTACK", "", "OK"};
	static const char* BUTTON3_TEXT = "UPGRADE";
	enum MENU_TYPE {MUSHROOM, UNIT, UNIT_ATK, MUSHROOM_UPGRADE, NO_SPAWN_SPACE}; // 0 = unit, 1 = mushroom, 2 = mushroom upgrade
...
protected:
	...
	RECT		button3Rect;			// button3 rectangle
	...
	LP_VERTEXBUFFER button3Verts;		// button3 vertex buffer
	...
	messageDialogNS::MENU_TYPE menuType;
...
public:
	...
	void setButtonClicked(int btnClkd) {buttonClicked = btnClkd;}
	...
	// set munu type
	void setMenuType(messageDialogNS::MENU_TYPE mt) { menuType = mt;}
