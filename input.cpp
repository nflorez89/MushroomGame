...
//=============================================================================
// returns true if the left mouse button is released from being pressed down,
// false otherwise.
//=============================================================================
bool Input::getMouseLButtonRelease()
{
	if (getMouseLButton())
	{
		lMouseDown = true;
	...
	else if(lMouseDown && !getMouseLButton())
	{
		lMouseDown = false;
		return true;
	}
...
// returns true if the left mouse button is released from being pressed down,
// false otherwise.
// Note: this function is specifically for the end turn button
//=============================================================================
bool Input::getMouseLButtonReleaseEndTurn()
{
	if (getMouseLButton())
	{
		lMouseDownEndTurn = true;
		return false;
	}
	else if(lMouseDownEndTurn && !getMouseLButton())
	{
		lMouseDownEndTurn = false;
		return true;
	}
