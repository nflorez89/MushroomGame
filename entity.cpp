...
//=============================================================================
void Entity::isAttackedBy(NematodeParasiteUnit* npu, float accuracySitMod, float evsSitMod)
{
	// get the enemy's attack and subtract it from this unit's hp
	setHealth(getHealth() - npu->getAttackDmg());
}

void Entity::isAttackedBy(NematodeBurrowerUnit* nemBurrowerUnit, float accuracySitMod, float evsSitMod)
{
	// get the enemy's attack and subtract it from this unit's hp
	setHealth(getHealth() - nemBurrowerUnit->getAttackDmg());
}

void Entity::isAttackedBy(NematodeRangedUnit* nemRangedUnit, float accuracySitMod, float evsSitMod)
{
	// get the enemy's attack and subtract it from this unit's hp
	setHealth(getHealth() - nemRangedUnit->getAttackDmg());
}

void Entity::isAttackedBy(NematodeCloseCombatUnit* nemCloseCombatUnit, float accuracySitMod, float evsSitMod)
{
	// get the enemy's attack and subtract it from this unit's hp
	setHealth(getHealth() - nemCloseCombatUnit->getAttackDmg());
}

void Entity::isAttackedBy(MushroomCloseCombatUnit* mushCloseCombatUnit, float accuracySitMod, float evsSitMod)
{
	// get the enemy's attack and subtract it from this unit's hp
	setHealth(getHealth() - mushCloseCombatUnit->getAttackDmg());
}

void Entity::isAttackedBy(MushroomParasiteUnit* mushParasiteUnit, float accuracySitMod, float evsSitMod)
{
	// get the enemy's attack and subtract it from this unit's hp
	setHealth(getHealth() - mushParasiteUnit->getAttackDmg());
}

void Entity::isAttackedBy(MushroomColonizerUnit* mushColonizerUnit, float accuracySitMod, float evsSitMod)
{
	// get the enemy's attack and subtract it from this unit's hp
	setHealth(getHealth() - mushColonizerUnit->getAttackDmg());
}

void Entity::isAttackedBy(MushroomRangedUnit* mushRangedUnit, float accuracySitMod, float evsSitMod)
{
	// get the enemy's attack and subtract it from this unit's hp
	setHealth(getHealth() - mushRangedUnit->getAttackDmg());
}

void Entity::updateDeathAnim(float frameTime)
{
	deathAnimImg.update(frameTime);
}

bool Entity::isDeathAnimComplete()
{
	return deathAnimImg.getAnimationComplete();
}