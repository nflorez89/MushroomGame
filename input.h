...
private:
	...
	bool	lMouseDown;			// true if the left mouse button is clicked down
	bool	lMouseDownEndTurn;
	//bool isReleased;
...
public:
	...
	bool getMouseLButtonRelease();

	bool getMouseLButtonReleaseEndTurn();
	...
	// getIsMouseReleased bool
	//bool getIsReleased() {return isReleased; }

	// set isReleased
	//void setIsReleased(bool ir) { isReleased = ir; }
